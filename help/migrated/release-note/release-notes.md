...
**VTT Overwrite Blocked by Character Limit:** Fixed an issue where the user was unable to overwrite the VTT file auto-generated by ALM because of character limit in review/edit mode. The character limit has now been increased to one million in VTT edit mode.
...
A GenAI-powered conversational tool designed to help your learners find responses, resources, and relevant courses instantly using natural language queries.

**Key highlights**

* Uses Retrieval-Augmented Generation (RAG) to intelligently search across course content, job aids, and learning materials to deliver accurate and contextual responses.
* Understands context, retains prior interactions, and provides citation-based answers as ground source of truth, these can be consumed later as needed.
* Empowers learners to request personalized scripts, talking points, and summaries tailored to their individual learning needs.
* Searches across all supported content formats, including PDF, DOCX, PPTX, Audio, Videos and SCORM 1.2 & 2004.
