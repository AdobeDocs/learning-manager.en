---
description: Learn how to export a Content Composer course theme as a JSON file — to customise properties outside the app, share with other authors, or use as the basis for a new theme.
jcr-language: en_us
