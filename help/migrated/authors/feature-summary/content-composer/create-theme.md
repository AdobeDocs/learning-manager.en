---
description: Learn how to create a custom course theme in Content Composer, either from scratch using the Create option, or by exporting an existing theme as JSON, editing its properties, and importing it back.
jcr-language: en_us
