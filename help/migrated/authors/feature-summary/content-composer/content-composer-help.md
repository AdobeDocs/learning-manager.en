...
Content Composer guides authors through training goals, source material, and learning objectives through conversation, then generates courses that are educationally sound, on-brand, and ready to publish directly to Adobe Learning Manager.

**Key highlights**

- **AI-guided course creation**: A conversational AI asks targeted questions to turn training goals into clear, measurable learning objectives.
- **Document-grounded generation**: Authors upload existing documents, policies, or decks. The AI generates a brief and outline from that material; authors accept or edit before anything is built.
- **Instructionally sound output**: Courses, assessments, and media are generated using structured learning principles, keeping output educationally effective, not just fast to produce.
...
<table style="table-layout:fixed">
 <tbody>
  <tr>
   <td>
    <a href="authors/content-composer/get-started.md">
    <img alt="Get started with Content Composer" src="../assets/cc-get started.png">
    </a>
    <div>
    <a href="authors/content-composer/get-started.md"><strong>Get started with Content Composer</strong></a>
    </div>
    <p>What Content Composer is, who it's for, and what you need before you begin.</p>
   </td>
   <td>
    <a href="authors/content-composer/create-course.md">
    <img alt="Create a course" src="../assets/cc-create-course.png">
    </a>
    <div>
    <a href="authors/content-composer/create-course.md"><strong>Create a course</strong></a>
    </div>
    <p>Go from a plain-language prompt to a publish-ready course in a single guided workflow.</p>
   </td>
   <td>
    <a href="authors/content-composer/prompt-guide.md">
    <img alt="Write effective prompts" src="../assets/cc-prompts.png">
    </a>
    <div>
    <a href="authors/content-composer/prompt-guide.md"><strong>Write effective prompts</strong></a>
    </div>
    <p>Learn how to write prompts that produce better briefs, stronger outlines, and more accurate AI-generated content.</p>
   </td>
   <td>
    <a href="authors/content-composer/share.md">
    <img alt="Share and collaborate" src="../assets/cc-share.png">
    </a>
    <div>
    <a href="authors/content-composer/share.md"><strong>Share and collaborate</strong></a>
    </div>
  ...
  <tr>
   <td>
    <a href="authors/content-composer/settings.md">
    <img alt="Configure course settings" src="../assets/cc-course-settings.png">
    </a>
    <div>
    <a href="authors/content-composer/settings.md"><strong>Configure course settings</strong></a>
    </div>
    <p>Set completion criteria, quiz scoring, and your Adobe Learning Manager connection before publishing.</p>
   </td>
   <td>
    <a href="authors/content-composer/themes.md">
    <img alt="Brand your course" src="../assets/cc-branding.png">
    </a>
    <div>
    <a href="authors/content-composer/themes.md"><strong>Manage course themes</strong></a>
    </div>
    <p>Apply, customize, create, and import visual themes to control how your course looks and feels.</p>
   </td>
   <td>
    <a href="authors/content-composer/alm-integration.md">
    <img alt="Publish to Adobe Learning Manager" src="../assets/cc-publish-alm.png">
    </a>
    <div>
    <a href="authors/content-composer/alm-integration.md"><strong>Publish to Adobe Learning Manager</strong></a>
    </div>
...
Quick answers, current constraints, and the full JSON schema. Everything you need to look something up fast.

<table style="table-layout:fixed">
 <tbody>
  <tr>
   <td>
    <a href="authors/content-composer/beta-limitations.md">
    <img alt="Beta limitations" src="../assets/cc-limitations.png">
    </a>
    <div>
    <a href="authors/content-composer/beta-limitations.md"><strong>Beta limitations</strong></a>
    </div>
    <p>A complete list of current constraints, workarounds, and roadmap status. Updated as features ship.</p>
   </td>
   <td>
    <a href="authors/content-composer/faq.md">
    <img alt="Content Composer FAQ" src="../assets/cc-faq.png">
    </a>
    <div>
    <a href="authors/content-composer/faq.md"><strong>Content Composer FAQ</strong></a>
    </div>
    <p>Quick answers to the most common questions about authoring, settings, sharing, and publishing.</p>
   </td>
   <td>
    <a href="authors/content-composer/theme-json-reference.md">
    <img alt="Theme JSON property reference" src="../assets/cc-theme-ref.png">
    </a>
    <div>
    <a href="authors/content-composer/theme-json-reference.md"><strong>Theme JSON property reference</strong></a>
    </div>
