...
1. Learning Manager supports captions for video content uploaded in Learning Manager. Now, authors can upload the file containing captions, along with the video file. 
   ...
   * Video announcements.
   * Video played within the eLlearningcontent. This is driven by the content.
   * Video uploaded in Social Learning.
   * Video created in Learning Manager desktop app.
   * Video content created using migration process.
   * Video playback in mobile app in offline mode.
...
3. **How to edit the details of a course in a different language?** After adding a language/languages, as described in an earlier section, click each language tab, and then add/edit the course information. ![](assets/edit-course-language.png)
