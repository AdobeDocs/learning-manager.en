...
**Is there a file size limit when exporting reports from Report Builder?**

Currently, exported report files larger than 5GB are not supported in Report Builder. If your report is expected to exceed this size, consider applying additional filters or reducing the number of rows to keep the export under 5GB.
