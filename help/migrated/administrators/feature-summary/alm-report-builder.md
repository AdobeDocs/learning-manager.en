...
Report Builder doesn't replace the existing fixed reports in Adobe Learning Manager. Both are available. Use existing reports for standard outputs you already rely on. Use Report Builder when you need custom columns, specific filters, or data that currently requires post-processing.
