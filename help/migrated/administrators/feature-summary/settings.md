...
<table>
 <tbody>
  <tr>
   ...
   <td>
    <p>If the option <b>Enable Extended features of Learning Path</b> is selected, Admins will be able to include Learning Paths inside Learning Paths, and combine those Learning Paths with Courses. The option is irreversible.<br></p></td>
  </tr>
  <tr>
   <td>
