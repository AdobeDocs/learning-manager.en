...
2. Select **Create report**. Type a name, for example, Engagement by user group MoM.
...
5. Select **+** next to **Time Spent**. Select the **edit** (pencil) icon and enter the alias Total time spent.
6. Expand **Learning Object** and select **+** next to **Enrollment User Count**. Select the **edit** icon and enter the alias Total enrollments.
...
11. Select **Add filter**. Choose **Enrollment - Enrolled Date**, select a relative range such as **Last 3 months,** or enter a specific date range.
