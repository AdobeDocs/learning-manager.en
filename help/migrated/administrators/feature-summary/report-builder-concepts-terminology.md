...
**Templates** are pre-built report configurations provided by Adobe Learning Manager. They're designed for common use cases, enrollment and completion tracking, compliance reporting, instructor performance, and are ready to download immediately. Templates are read-only; you can't edit or overwrite them.
...
This lets you build conditions like: (catalog = Safety OR catalog = Hygiene) AND completion date is in the last 90 days.
...
Report Builder supports including deleted learners in reports and retrieving their active field values.
