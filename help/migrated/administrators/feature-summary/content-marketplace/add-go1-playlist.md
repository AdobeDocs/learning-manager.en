...
This feature allows administrators to directly curate and add Go1 courses learning paths and recurring certifications. Administrators can create a learning path that includes a Go1 playlist, so learners can access selected Go1 courses as part of their training.

>[!INFO]
>
>Customers with an active Go1 license can add Go1 courses to a learning path or certification.
...
5. Search and select the required courses. The playlist has been created with related courses.
6. Select the playlist from the **[!UICONTROL Select playlist to import prompt]**. 
7. Select **[!UICONTROL Add Playlists to Learning Path]** and then **[!UICONTROL Publish]**. 
