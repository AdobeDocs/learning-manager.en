...
2. Type a name such as **Instructor efficiency**.
3. Add **Instructor Names** from the **Module** dataset.
4. Add **Module ID** from the **Module** dataset. You'll aggregate this to count sessions.
...
7. Apply **Count** to **Module ID**. Type the alias Total sessions.
8. Apply **Count if** to **Status**, select Completed. Type the alias **Total completions**.
9. To also show total enrollments, add **Status** a second time. Apply **Count if** to Not Started. Type the alias Total enrollments.
