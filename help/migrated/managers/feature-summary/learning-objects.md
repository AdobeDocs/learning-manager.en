...
![](assets/filter-learning%20paths.png)
...
## Add learners to a learning paths {#addlearnerstoalearningprogram}

1. In Manager mode, click Learning Pathss on the left pane.
1. Select the published learning program from the list of tiles, to which you want to add learners.
1. Click Learners on the left pane under Program reports category. Note: Learning Paths must be published before adding learners.
