...
|---|---|
|**Pre-session**|The Administrator enables Live Hub for the account, the Author creates the Live Hub course, and the Instructor prepares the room by configuring layouts, content, and interactive activities for the upcoming session.|
...
|**Post-session**|Instructor reviews session recordings, attendance reports, and engagement analytics to assess Learner participation and evaluate the session's effectiveness. Learners can revisit the session through a topic-based recording view that splits the recording into navigable topics, each with a title, overview, and notes, so they can jump to any topic or read it instead of watching.|
