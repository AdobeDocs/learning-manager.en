...
>[!NOTE]
>
> Only Instructors can see the engagement meter. Learners don't have access to it.

## Understand engagement level calculations
...
* **Browser focus**: Whether the Virtual Classroom tab or window is active on the learner's screen.

* **Chat activity**: Learner participation through messages in the session chat.

* **Poll participation**: Responses submitted to polls during the session.

## Identify engagement levels and indicators

Participant engagement uses color-coded indicators based on learner interaction. Here's what each level means:

| **Engagement level** | **Color indicator** | **Description** |
|----|----|----|
| High | Green | Learners actively participate in the session. |
| Medium | Yellow | Learners show occasional interaction with moderate participation. |
| Low | Red | Learners show minimal or no interaction or reduced focus during the session. |
