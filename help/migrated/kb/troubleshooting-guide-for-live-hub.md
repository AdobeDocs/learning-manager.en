...
|Summary could not be generated.|This error can appear in three places:  the live **Check Room** summary, a **room-specific** summary in the Breakout report, and the **overall summary** in the Breakout report depending on the cause: <ul><li>No participant spoke during the room's discussion.</li><li>The room's discussion lasted less than 60 seconds.</li><li>Only one breakout room have generated summary.</li></ul>|Match the fix to the cause above: <ul><li>Ensure participants actively speak during the room's discussion.</li><li>Ensure the discussion lasts at least 60 seconds before checking or generating the summary.</li><li>Ensure at least 2 breakout rooms have generated individual summaries before the overall summary can be generated.</li><li>If the issue persists after addressing the relevant cause, wait a moment and try again.</li></ul>|
